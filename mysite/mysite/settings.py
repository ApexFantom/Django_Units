...
# MEDIA_URL = 'mysite/units/templates/Gulp/src/img/UnitModule'
# STATIC_ROOT = 'c:/Python27/Scripts/todo/collected_static/'
STATIC_URL = 'units/static/'
STATICFILES_DIRS = [
    BASE_DIR / "units/static/",
]
# MEDIA_URL = '/media/'
...
AUTH_USER_MODEL = 'units.CustomUser'
...
CACHES = {
    ...
    'LOCATION': os.path.join(BASE_DIR, 'units_cache')
}
}
